...
<div id="wrapper_modificar_perfil">
	<div id="form_modificar">
		<form id="form_crear_usuario" action="proc/modificar_perfil.proc.php" method="GET">
			<input hidden style="width: 120px; height: 20px" type="text" name="mail_usuario" value="<?php echo $tbl_array['usu_mail'] ?>" size="15" maxlength="50">
			<p>Password:</p>
