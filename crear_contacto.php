...
<body  onload="initialize(); initialize2()">
	<div id="wrapper_crear_contacto">
		<form id="form_crear_contacto" action="proc/crear_contacto.proc.php" method="GET">
			<div id="form_contenido">
			<p>Nombre:</p>
			<p><input id="val_nombre" style="width: 120px; height: 17px" type="text" name="nombre_contacto" size="15" maxlength="25"></p>
			<p>Apellidos:</p>
			<p><input id="val_apellidos" style="width: 120px; height: 17px" type="text" name="apellidos_contacto" size="15" maxlength="25"></p>
			<p>Mail:</p>
			<input id="val_mail" style="width: 120px; height: 20px" type="text" name="mail_contacto" size="15" maxlength="50">
			<p>Telefono 1:</p>
